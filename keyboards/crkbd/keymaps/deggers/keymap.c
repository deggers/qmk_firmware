...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_3x5_3(
          KC_W,                  KC_C,                 KC_D,                 KC_L,                  KC_SLASH,                                      KC_QUOTE,                KC_Y,                  KC_O,               KC_U,              KC_Q,
          MT(MOD_RGUI,KC_R),     MT(MOD_LALT,KC_S),    MT(MOD_LCTL,KC_T),    MT(MOD_LSFT,KC_H),     MT(MOD_RALT,KC_K),                         MT(MOD_RALT,KC_P),     MT(MOD_LSFT,KC_N),     MT(MOD_LCTL,KC_E), MT(MOD_LALT,KC_I), MT(MOD_RGUI,KC_A),
          KC_V,                  KC_B,                  KC_G,                KC_M,                   KC_COMMA,                                     KC_DOT,                  KC_F,                  KC_J,               KC_X,          KC_Z,
